...
<section class="hero-container" style="padding: clamp(60px, 10vh, 120px) 20px 40px; text-align: center;">
    ...
    <section style="padding: 100px 20px; background: #fff; color: #000;">
        <div style="max-width: 1250px; margin: 0 auto; display: flex; flex-wrap: wrap; gap: 40px; align-items: flex-start;">
            <div style="flex: 0 0 40%; min-width: 300px;">
                <h2 class="montserrat" style="font-size: 70px; font-weight: 900; line-height: 1; margin-bottom: 25px; text-transform: uppercase; color: #2D236E;">FORUM<br>HIGHLIGHTS</h2>
                <p style="font-size: 1.25rem; line-height: 1.6; color: #333; margin-bottom: 40px; max-width: 400px; font-weight: 500;">
                    This curated tour emphasizes how history shapes diplomacy, peacebuilding, and leadership today.
                </p>
                <a href="#seats-section" class="btn-custom-animate" style="padding: 18px 45px !important; font-size: 1.1rem !important; background: #2D236E; color: #fff; text-decoration: none; border-radius: 5px; display: inline-block;">Register Now</a>
            </div>
            
            <div style="flex: 0 0 55%; min-width: 300px; display: flex; flex-direction: column; gap: 20px;">
                <!-- Workshop Item -->
                <div style="background: #2D236E; padding: 20px 40px; border-radius: 50px; display: flex; align-items: center; gap: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); min-height: 90px; margin-bottom: 20px;">
                    <div style="flex-shrink: 0; width: 50px; height: 50px; background: #FFD700; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                    ...
                    <h3 class="montserrat" style="margin: 0; font-size: 1.2rem; font-weight: 700; color: #fff;">Expert-led Workshops & Interactive Masterclasses</h3>
                </div>
                ...
                <div style="background: #2D236E; padding: 20px 40px; border-radius: 50px; display: flex; align-items: center; gap: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); min-height: 90px; margin-bottom: 20px;">
                    ...
                    <h3 class="montserrat" style="margin: 0; font-size: 1.2rem; font-weight: 700; color: #fff;">Youth Diplomacy Sessions & Policy Dialogues</h3>
                </div>
                ...
                <div style="background: #2D236E; padding: 20px 40px; border-radius: 50px; display: flex; align-items: center; gap: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); min-height: 90px; margin-bottom: 20px;">
                    ...
                    <h3 class="montserrat" style="margin: 0; font-size: 1.2rem; font-weight: 700; color: #fff;">Networking with global leaders & institutions</h3>
                </div>
                ...
                <div style="background: #2D236E; padding: 20px 40px; border-radius: 50px; display: flex; align-items: center; gap: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); min-height: 90px; margin-bottom: 20px;">
                    ...
                    <h3 class="montserrat" style="margin: 0; font-size: 1.2rem; font-weight: 700; color: #fff;">Cultural Immersion & Berlin City Study Tours</h3>
                </div>
            </div>
        </div>
    </section>
...
<section id="seats-section" class="participation-seats" style="padding: 60px 20px; text-align: center; background: #fff;">
    ...
    <section style="background: url('attached_assets/istock-486585530_1768550282103.jpg') center/cover no-repeat fixed; color: white; text-align: center; position: relative;">
        ...
        <div style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); display: grid; gap: 20px; max-width: 1100px; margin: 0 auto 40px;">
            <!-- Forum Admission Detail -->
            <div style="background: #2D236E; border-radius: 16px; padding: 30px 20px; border: 1px solid rgba(255, 255, 255, 0.1); text-align: left; box-shadow: 0 10px 30px rgba(0,0,0,0.3); display: flex; flex-direction: column;">
            ...
            <!-- Visa Invitation Letter Detail -->
            <div style="background: #2D236E; border-radius: 16px; padding: 30px 20px; border: 1px solid rgba(255, 255, 255, 0.1); text-align: left; box-shadow: 0 10px 30px rgba(0,0,0,0.3); display: flex; flex-direction: column; overflow: hidden; position: relative;">
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 120px; overflow: hidden; z-index: 0;">
                ...
                <div style="position: relative; z-index: 1; flex-grow: 1; display: flex; flex-direction: column;">
                    <div style="font-size: 2.2rem; font-weight: 800; margin-bottom: 10px; text-align: center; padding-top: 100px;"><span style="text-decoration: line-through; font-size: 1.2rem; opacity: 0.6; margin-right: 10px;">$299.99</span>$149.99</div>
                    ...
                    <div style="border-top: 1px dashed rgba(255, 255, 255, 0.3); padding-top: 15px; flex-grow: 1;">
                        <h4 style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 15px; text-align: center; color: rgba(255, 255, 255, 0.7);">What's Included</h4>
                        <ul style="list-style: none; padding: 0; margin: 0; font-size: 0.8rem; line-height: 1.6;">
                            <li style="margin-bottom: 8px; display: flex; gap: 8px;"><span style="color: #FFD700;">✉️</span> Official Invitation Letter</li>
                            <li style="margin-bottom: 8px; display: flex; gap: 8px;"><span style="color: #FFD700;">📋</span> Documents Checklist</li>
                            <li style="margin-bottom: 8px; display: flex; gap: 8px;"><span style="color: #FFD700;">📄</span> Participation Confirmation</li>
                            <li style="margin-bottom: 8px; display: flex; gap: 8px;"><span style="color: #FFD700;">🏢</span> Embassy Coordination</li>
                        </ul>
                    </div>
                    <a href="apply?package=visa_letter" class="btn-slide-animation" style="display: block; width: 100%; padding: 18px 0; background: linear-gradient(to right, #000 0%, #a67c00 50%, #cca300 100%); color: #fff; text-align: center; border-radius: 8px; text-decoration: none; font-weight: 700; margin-top: 15px; text-transform: uppercase; font-family: 'Montserrat', sans-serif; letter-spacing: 1px;">APPLY NOW!</a>
                </div>
            </div>
        </div>
    </section>
