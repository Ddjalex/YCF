...
<div class="hero-container" style="padding-top: 100px; min-height: auto; background: url('attached_assets/intro_image.jpg') center/cover no-repeat fixed;">
    <div style="background: rgba(45, 35, 110, 0.85); width: 100%; padding: 60px 20px; color: white; text-align: center;">
        <h1 class="montserrat" style="font-size: clamp(2rem, 5vw, 3.5rem); margin-bottom: 20px;">Youth Crypto Forum 2026<br><?php echo str_replace('YDF ', '', str_replace(' Registration', '', $current_package_name)); ?></h1>
    ...
    <div id="intro-section" style="display: flex; flex-wrap: wrap; gap: 40px; align-items: flex-start;">
        ...
        <div style="flex: 1; min-width: 300px; text-align: center;">
            <div style="background: #eee; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                <img src="attached_assets/intro_image.jpg" style="width: 100%; height: auto; display: block;">
            </div>
        </div>
    </div>
        ...
        <div id="step1">
            ...
            <div class="form-step-container">
                ...
                <div style="display: flex; justify-content: flex-start;">
                    <button type="button" onclick="nextStep(2)" class="btn-apply-special">NEXT</button>
                </div>
            </div>
        </div>
        ...
        <div id="step2" style="display: none;">
            ...
            <div class="form-step-container">
                ...
                <div style="display: flex; justify-content: flex-start; gap: 20px;">
                    ...
                    <button type="button" onclick="nextStep(3)" class="btn-apply-special" style="margin-top: 0;">NEXT</button>
                </div>
            </div>
        </div>
...
function handleFinalSubmit() {
    ...
    const targetUrl = 'process_registration.php?t=' + Date.now();
